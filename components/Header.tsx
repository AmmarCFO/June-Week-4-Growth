    ...
    >
      <div className="max-w-7xl mx-auto bg-white/70 backdrop-blur-xl border border-white/40 shadow-sm rounded-2xl px-6 py-4 flex items-center justify-between">
          ...
          <button 
            ...
            className="px-4 py-2 text-sm font-medium text-[#1D1D1F] bg-gray-100/50 hover:bg-gray-100 rounded-full transition-all active:scale-95 border border-transparent hover:border-gray-200"
          >
            العربية
          </button>
      </div>
