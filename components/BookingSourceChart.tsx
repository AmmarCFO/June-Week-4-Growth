              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    ></div>
                    <div>
                      <p className="font-bold text-[#4A2C5A] text-base sm:text-lg leading-tight">{entry.name}</p>
                      <p className="text-[10px] sm:text-xs text-[#4A2C5A]/50 font-semibold uppercase tracking-wider">{percentage}% of total</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <span className="block text-xl sm:text-2xl font-bold text-[#4A2C5A] leading-none">{entry.value}</span>
                    <span className="text-[10px] sm:text-xs text-[#4A2C5A]/50 font-medium font-normal">Tenants</span>
                  </div>
                </div>
              );
            })}
